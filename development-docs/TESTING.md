...
If you didn't create the Kafka cluster you should do so at the beginning of the test using a test method resources instance of `Resources` inherited from `BaseST`.
